...
int main()
{
	...
	cout<<"\n\t---------------------------------------------------------\n";
	cout<<"\t        WELCOME TO SERENE DRIVE\n";
	cout<<"\t---------------------------------------------------------\n";
	cout<<"\t You are a step ahead to embark a beautiful journey with us.\n";
	cout<<"\nEnter the number of your group members.\n";
	cin>>a;
	cout<<"Enter the Age of "<<a<<" Members:\n";
	for(i=0;i<a;i++)
	{
		cin>>age[i];
	}
	...
	cout<<"\n\n=====================================\n";
	cout<<"\nTotal Amount to be paid is: "<<sum+sum2;
